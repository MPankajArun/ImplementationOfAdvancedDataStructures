...
public class LinkedListPolynomialAddition {
	...
	public static void main(String[] args) {
		...
		String addedNde=addNumber("87675673456", "5432432321", 10000);
		System.out.println("ADD OUTPUT : "+addedNde);
		
		String resultSub=subractNumber("87675673456", "5432432321", 10000);
		System.out.println("SUBRACT OUTPUT : "+resultSub);
		
		String resultMul=multiplicationHandler("87675673456", "5432432321", 10000);
		System.out.println("MULTIPLY OUTPUT : "+resultMul);
		
		String resultExp=ExponentialHandler("3", n);
	...
	{
		LinkedList<Node> lList1=frameList(sNum1, 10000);
		LinkedList<Node> lList2=frameList(sNum2, 10000);
		LinkedList<Node> resList=new LinkedList<Node>();
		String sResult="";
		String sData="";
	...
	{		
		LinkedList<Node> oList1=frameList(sNum1, 10000);
		LinkedList<Node> oList2=frameList(sNum2, 10000);
		String resl=multiplyNumber(oList1, oList2, 10000);
	...
	public static String addTrailingZeros(int nNum, int nBase)
	{
			int noOfDigit=(int) Math.log10(nBase);
	...
	public static String mPowerN(String m, int n)
	{
		...
		if((n&1)==0)
		{
			hDynamicMap.put(n, multiplicationHandler(mPowerN(m, n/2), mPowerN(m, n/2), 10000));
		}else
		{
			hDynamicMap.put(n, multiplicationHandler(m, multiplicationHandler(mPowerN(m, n/2), mPowerN(m, n/2), 10000), 10000));

...
public class TreeNode {
	...
	public void inOrderTraversal(TreeNode root, TreeNode rightRoot, String inorderPos)
	{
		if(root==null&&inorderPos.equals("left"))
			return;
		if(rightRoot==null&&inorderPos.equals("right"))
			return;
		inOrderTraversal(root.left,rightRoot,"left");
		inOrderTraversal(root, rightRoot.right, "right");
		
		System.out.println("Node Value : "+root.data);

		System.out.println("Node Value reversein order: "+rightRoot.data);

		inOrderTraversal(root.right,rightRoot, "left");
		inOrderTraversal(root, rightRoot.left,"right");

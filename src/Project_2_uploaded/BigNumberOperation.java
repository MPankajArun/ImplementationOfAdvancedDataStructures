...
public class BigNumberOperation {
	...
	public static void main(String[] args) {
		...
		long inTime=0;
		try {
			FileInputStream in = new FileInputStream("/users/dany/downloads/inputFile.txt");
	...
	private static String performOperation(char op, String op1, String op2)
		...
		switch (op) {
		case '+':
			return LinkedListPolynomial.addNumber(op1, op2);
		case '-':
			return LinkedListPolynomial.subractNumber(op2, op1);
		case '*':
